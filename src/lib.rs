...
impl State {
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        let diffuse_texture =
            texture::Texture::from_bytes(&device, &queue, diffuse_bytes, "uv-checker_4k.png")
                .unwrap();

        let texture_binding_group_layout =
        ...
        let obj_model =
            resources::load_model("cube.obj", &device, &queue, &texture_binding_group_layout)
                .await
                .unwrap();
        ...
        let rendering_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                ...
                bind_group_layouts: &[&texture_binding_group_layout, &camera_binding_group_layout],
