...
| [`solarxy-app`](crates/solarxy-app/) | winit `ApplicationHandler` + egui: the desktop shell (the menu bars, the dock and its panels, the node canvas, named arrangements, dialogs, review UI). |
