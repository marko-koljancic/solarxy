...
pub fn about(info: &AppInfo) -> Text<'static> {
    Text::from(vec![
        ...
        prose(""),
        prose("    solarxy-cli -M analyze -m model.obj"),
        blank(),
        prose("  Export analysis as JSON:"),
        prose(""),
        prose("    solarxy-cli -M analyze -m model.obj -f json"),
        blank(),
        prose("  Open this documentation:"),
        prose(""),
        prose("    solarxy-cli -M docs"),
        blank(),
        prose("  Update to the latest version:"),
        prose(""),
        prose("    solarxy-cli --update"),
        blank(),
        blank(),
        ...
        shortcut_line("--update", "Check for updates and self-update"),
