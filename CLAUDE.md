...
**12-crate workspace + the `web/` frontend** (the web-expansion milestone added `solarxy-kernel`, `solarxy-graph`, `solarxy-scenefile`, `solarxy-web`, and `web/`):
