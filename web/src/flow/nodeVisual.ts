...
export const GLYPH_PATHS: Record<string, string> = {
  ...
  attribute_create: "M 2.75 5 h 6 l 4.5 3 -4.5 3 h -6 z M 5.25 8 h 3 M 6.75 6.5 v 3",
  attribute_randomize:
  ...
  cone: "M 8 2.65 l 4.5 8.3 m -4.5 -8.3 l -4.5 8.3 m 9.2 0.7 a 4.7 1.7 0 1 1 -9.4 0 4.7 1.7 0 1 1 9.4 0",
  cylinder:
  ...
  displace: "M 2.5 11.85 H 5 c 1 -3.5 5 -3.5 6 0 h 2.5 M 8 8.35 V 4.15 m -1.6 1.6 L 8 4.15 l 1.6 1.6",
  ...
  compute_normals: "M 2.5 12.5 c 2 -2 9 -2 11 0 m -5.5 -2.5 v -6.5 m 0 0 l -2 2 m 2 -2 l 2 2",
  ...
  uv_project: "M 2.89 6.5 h 7 v 7 h -7 z m 7 0 c 2.6 0 3.6 -2 3.1 -4 m -6.6 4 v -2 m -3.5 5.5 h 7",
  ...
  hemisphere: "M 2.5 10.1 h 11 m -9.7 0 a 4.2 4.2 0 0 1 8.4 0",
  point:
  ...
  rect_area: "M 2.75 3 h 6 v 10 h -6 z m 8 2 h 2.5 m -2.5 3 h 2.5 m -2.5 3 h 2.5",
  ...
  ramp: "M 2.5 4.25 h 11 v 3.5 h -11 z m 1.5 5.5 v 2 m 4 -2 v 2 m 4 -2 v 2",
  noise:
  ...
  levels: "M 2.5 12.45 h 11 m -9 -0.2 v -4 m 2.6 4 v -7.5 m 2.6 7.5 v -5.3 m 2.6 5.3 v -8.7",
  brightness_contrast:
  ...
  gamma: "M 4.5 3.15 c 0.8 3.2 2 5.2 3.6 6.8 m 3.4 -6.8 c -0.2 4.6 -1.6 7.6 -4 9.7",
  ...
  pack_orm: "M 8 2.35 l 5.5 3 -5.5 3 -5.5 -3 z m -5.5 5.7 l 5.5 3 5.5 -3 m -11 2.6 l 5.5 3 5.5 -3",
  height_to_normal:
  ...
  tex_ref: "M 7 4 h 7 v 8 h -7 z M 8.5 10 l 1.8 -2.2 1.6 1.9 M 2 8 h 3.6 m -1.5 -1.6 L 5.8 8 l -1.7 1.6",
...
/** The one layout box every canvas role occupies. Handles, wires, labels,
 * selection and auto-layout all read this box; the visible body inside it
 * is the role's own affair. */
export const NODE_BOX = { w: 112, h: 32 } as const;
